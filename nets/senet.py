...
def model(inputs,
  ...
  """
  blocks = [
      resnet_utils.Block('block1', resnet_utils.bottleneck_se, [(256, 64, 1)] * 2 + [(256, 64, 2)]),
      resnet_utils.Block('block2', resnet_utils.bottleneck_se,
                         [(512, 128, 1)] * 3 + [(512, 128, 2)]),
      resnet_utils.Block('block3', resnet_utils.bottleneck_se,
                         [(1024, 256, 1)] * 5 + [(1024, 256, 2)]),
      resnet_utils.Block('block4', resnet_utils.bottleneck_se, [(2048, 512, 1)] * 3)
  ]
  return seresnet_v2(
      inputs,
      is_training,
