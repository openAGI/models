...
from tefla.core.layers import conv2d, max_pool, prelu, global_avg_pool, softmax, batch_norm_tf as batch_norm
...
def bottleneck(inputs, depth, depth_bottleneck, stride, rate=1, name=None, **kwargs):
    ...
    with tf.variable_scope(name, 'bottleneck_v2', [inputs]):
        ...
        residual = conv2d(preact, depth_bottleneck, filter_size=(1, 1), stride=(stride, stride),
                          name='conv1', **kwargs)
