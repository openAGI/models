...
def prepare_data(seqs, labels, maxlen=None):
  ...
  This pad each sequence to the same lenght: the lenght of the longuest
  sequence or maxlen. if maxlen is set, we will cut all sequence to this
  maximum lenght. This swap the axis!
  """
...
def get_dataset_file(dataset, default_dataset, origin):
  """Look for it as if it was a full path, if not, try local file, if not try
