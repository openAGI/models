...
def download_data(data_path=data_path):
  ...
  dataset_utils.maybe_download(url=data_url + train_data, download_dir=data_path)
  dataset_utils.maybe_download(url=data_url + test_data, download_dir=data_path)
  dataset_utils.maybe_download(url=data_url + extra_data, download_dir=data_path)
  ...
  with tf.Graph().as_default():
    ...
    with tf.Session('') as sess:
      ...
      for j in range(num_images):
        ...
        example = tfrecords.convert_to_example(filename_image, jpg_string, label, 'svhn', width,
                                               height)
